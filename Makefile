...
BUILD		:=	build
SOURCES		:=	source source/debug source/core source/math source/gx source/game source/game/input source/ext source/core/components
DATA		:=	data
INCLUDES	:=	include source/debug source/core source/math source/gx source/game source/game/input source/ext source/core/components
ROMFS		:=	romfs
APP_TITLEID := 329
APP_VERSION := 1.0
APP_AUTHOR := Emistro
